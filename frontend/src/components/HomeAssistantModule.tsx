      ...
      <div className="relative">
        ...
        <div className="relative max-w-3xl mx-auto px-6 py-8 lg:py-10 text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-ub-blue/10 dark:bg-ub-blue/20 px-4 py-1.5 mb-4">
            <svg viewBox="0 0 24 24" fill="none" className="size-4 text-ub-blue" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {features.map((f) => (
            <div key={f.title} className="rounded-xl border border-ui-border dark:border-noc-border bg-ui-surface dark:bg-noc-surface p-5 hover:border-ui-border-hover dark:hover:border-noc-border-hover transition-colors">
              <div className="inline-flex items-center justify-center size-10 rounded-lg bg-ub-blue/10 dark:bg-ub-blue/20 text-ub-blue mb-3">
                {f.icon}
              </div>
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-ui-text-secondary dark:text-noc-text-secondary">
            {[
              ...
              <li key={req} className="flex items-center gap-2">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-4 text-status-success shrink-0">
