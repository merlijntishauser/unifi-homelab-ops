  ...
  return (
    <form onSubmit={onSubmit} className="space-y-2">
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full rounded-lg bg-ub-blue px-3 py-1.5 text-xs font-semibold text-white hover:bg-ub-blue-light focus:outline-none focus:ring-2 focus:ring-ub-blue/40 focus:ring-offset-1 dark:focus:ring-offset-noc-surface disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer transition-[color,background-color,opacity]"
      >
